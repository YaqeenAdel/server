...
namespace YaqeenDAL.Migrations
{
    ...
    [Migration("20240210151106_cron-validator")]
    partial class cronvalidator
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YaqeenDAL.Model.Schedule", b =>
                {
                    ...
                    b.ToTable("Schedules", t =>
                        {
                            t.HasCheckConstraint("CronExpression", "CronExpression ~* '/(@(annually|yearly|monthly|weekly|daily|hourly|reboot))|(@every (\\d+(ns|us|µs|ms|s|m|h))+)|((((\\d+,)+\\d+|(\\d+(\\/|-)\\d+)|\\d+|\\*) ?){5})/'");
                        });
                });
