...
namespace YaqeenDAL.Migrations
{
    ...
    [Migration("20240612121503_symptoms-users-relationship")]
    partial class symptomsusersrelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YaqeenDAL.Model.OneOffSchedule", b =>
                {
            ...
            modelBuilder.Entity("YaqeenDAL.Model.Symptom", b =>
                {
                    ...
                    b.Property<int?>("OneOffScheduleScheduleId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("OneOffScheduleScheduleId");
            ...
            modelBuilder.Entity("YaqeenDAL.Model.Symptom", b =>
                {
                    b.HasOne("YaqeenDAL.Model.OneOffSchedule", null)
                        .WithMany("Symptom")
                        .HasForeignKey("OneOffScheduleScheduleId");

                    b.HasOne("YaqeenDAL.Model.User", "Patient")
                        .WithMany()
