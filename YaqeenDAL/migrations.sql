...
ALTER TABLE "Doctors" DROP COLUMN "VerificationStatus_Notes";
...
ALTER TABLE "Users" ALTER COLUMN "UserId" TYPE text;
ALTER TABLE "Users" ALTER COLUMN "UserId" DROP IDENTITY;

ALTER TABLE "Questions" ALTER COLUMN "UserId" TYPE text;

ALTER TABLE "Questions" ALTER COLUMN "PatientUserId" TYPE text;

ALTER TABLE "Patients" ALTER COLUMN "UserId" TYPE text;

ALTER TABLE "InterestUser" ALTER COLUMN "UsersUserId" TYPE text;

ALTER TABLE "Interests" ALTER COLUMN "PatientUserId" TYPE text;

ALTER TABLE "Doctors" ALTER COLUMN "UserId" TYPE text;
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20231001151702_make-UserId-string', '7.0.11');
