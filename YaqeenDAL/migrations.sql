...
ALTER TABLE "Users" ALTER COLUMN "UserId" ADD GENERATED BY DEFAULT AS IDENTITY;

ALTER TABLE "Questions" ALTER COLUMN "UserId" TYPE integer;

ALTER TABLE "Questions" ALTER COLUMN "PatientUserId" TYPE integer;

ALTER TABLE "Patients" ALTER COLUMN "UserId" TYPE integer;

ALTER TABLE "InterestUser" ALTER COLUMN "UsersUserId" TYPE integer;

ALTER TABLE "Interests" ALTER COLUMN "PatientUserId" TYPE integer;

ALTER TABLE "Doctors" ALTER COLUMN "VerificationStatus_VerifierUserId" TYPE integer;

ALTER TABLE "Doctors" ALTER COLUMN "UserId" TYPE integer;

ALTER TABLE "Bookmarks" ALTER COLUMN "UserId" TYPE integer;

ALTER TABLE "Answers" ALTER COLUMN "DoctorId" TYPE integer;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20231001050341_idp-user-id', '7.0.11');
