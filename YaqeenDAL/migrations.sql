...
ALTER TABLE "Symptoms" ADD "OneOffScheduleScheduleId" integer NULL;

CREATE TABLE "OneOffSchedules" (
    "ScheduleId" integer GENERATED BY DEFAULT AS IDENTITY,
    "UserId" text NOT NULL,
    "EntityType" schedule_entity_type NOT NULL,
    "Entity" jsonb NOT NULL,
    ...
    "UpdatedAt" timestamp with time zone NULL,
    "DeletedAt" timestamp with time zone NULL,
    CONSTRAINT "PK_OneOffSchedules" PRIMARY KEY ("ScheduleId"),
    CONSTRAINT "FK_OneOffSchedules_Users_UserId" FOREIGN KEY ("UserId") REFERENCES "Users" ("UserId") ON DELETE CASCADE
);

CREATE INDEX "IX_Symptoms_OneOffScheduleScheduleId" ON "Symptoms" ("OneOffScheduleScheduleId");

CREATE INDEX "IX_OneOffSchedules_EntityType_UserId" ON "OneOffSchedules" ("EntityType", "UserId");

CREATE INDEX "IX_OneOffSchedules_UserId" ON "OneOffSchedules" ("UserId");

ALTER TABLE "Symptoms" ADD CONSTRAINT "FK_Symptoms_OneOffSchedules_OneOffScheduleScheduleId" FOREIGN KEY ("OneOffScheduleScheduleId") REFERENCES "OneOffSchedules" ("ScheduleId");

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20240308143207_track-oneofftable', '7.0.11');
...
ALTER TABLE "Symptoms" ALTER COLUMN "SymptomLookupId" DROP NOT NULL;
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20240325213350_insert-schedule-symptoms', '7.0.11');
